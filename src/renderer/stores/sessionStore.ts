...
export const useSessionStore = create<State>((set, get) => ({
  ...
  toggleCustomize: () => {
    ...
    if (s.customizeOpen) {
      ...
      set({ isExpanded: false, customizeOpen: true, marketplaceOpen: false })
    }
  },
  ...
  toggleMarketplace: () => {
    ...
    if (s.marketplaceOpen) {
      ...
      set({ isExpanded: false, marketplaceOpen: true, customizeOpen: false })
      get().loadMarketplace()
    }
  },
  ...
  buildYourOwn: () => {
    set({ marketplaceOpen: false, customizeOpen: false, isExpanded: true })
